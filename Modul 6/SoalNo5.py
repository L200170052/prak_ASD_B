...
c0 = MhsTIF('Bayu', 10, 'Sragen', 2400000)
c1 = MhsTIF('Luluk', 51, 'Surakarta', 2300000)
c2 = MhsTIF('Saiful', 2, 'Sragen', 2500000)
c3 = MhsTIF('Boy', 18, 'Surakarta', 235000)
c4 = MhsTIF('Pablo', 4, 'Boyolali', 2400000)
c5 = MhsTIF('John', 31, 'Salatiga', 2500000)
c6 = MhsTIF('Mayer', 13, 'Klaten', 2450000)
c7 = MhsTIF('Galuh', 5, 'Wonogiri', 2450000)
c8 = MhsTIF('Arief', 23, 'Klaten', 2450000)
c9 = MhsTIF('Billie', 64, 'Karanganyar', 2700000)
