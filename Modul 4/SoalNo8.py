...
print("Cara menjalankan nya dengan cara binSearching(kumpulan,dan target angka brp)")

"""
mencari berapa tebakan yg digunakan dgn Binary Search
yaitu dgn menggunakan Logaritma basis 2 (log2(n))
misalkan :
